object frmIAEDepto: TfrmIAEDepto
  Left = 380
  Top = 86
  BorderStyle = bsToolWindow
  Caption = 'Blue Bean - Cadastro de Departamentos'
  ClientHeight = 257
  ClientWidth = 585
  Color = clBtnFace
  ...
  object edtSiglaDep: TEdit
    Left = 329
    Top = 115
    Width = 103
    Height = 21
    Hint = 'Digite aqui uma sigla para o departamento'
  ...
  object mmObsDep: TMemo
    Left = 329
    Top = 163
    Width = 247
    Height = 53
    Hint = 'Digite aqui informa'#231#245'es relevantes ao departamento'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object grdPsqDepto: TDBGrid
    Left = 9
    Top = 27
    Width = 295
    Height = 221
    DataSource = dtsPsqDepto
    FixedColor = 16635790
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    ...
    OnDrawColumnCell = grdPsqDeptoDrawColumnCell
    Columns = <
      item
        Expanded = False
        Width = 10
  ...
  object stpIAEDepto: TADOStoredProc
    Connection = frmMain.ADOConnection1
    ProcedureName = 'spIAEDepartamento;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dtsPsqDepto: TDataSource
    DataSet = stpPsqDepto
    Left = 152
    Top = 120
  end
  object stpPsqDepto: TADOStoredProc
    Connection = frmMain.ADOConnection1
    CursorType = ctStatic
    AfterScroll = stpPsqDeptoAfterScroll
