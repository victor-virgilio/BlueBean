object frmIAEUnidade: TfrmIAEUnidade
  Left = 371
  Top = 80
  BorderStyle = bsToolWindow
  Caption = 'Blue Bean - Cadastro de Unidades'
  ClientHeight = 257
  ClientWidth = 585
  Color = clBtnFace
  ...
  object edtDescUni: TEdit
    Left = 401
    Top = 67
    Width = 175
    Height = 21
    Hint = 'Digite aqui um nome para  o unidade'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object edtSiglaUni: TEdit
    Left = 329
    Top = 115
    Width = 63
    Height = 21
    Hint = 'Digite aqui uma sigla para a unidade'
  ...
  object mmObsUni: TMemo
    Left = 329
    Top = 163
    Width = 247
    Height = 53
    Hint = 'Digite aqui informa'#231#245'es relevantes '#224' unidade'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object grdPsqUni: TDBGrid
    Left = 9
    Top = 27
    Width = 295
    Height = 221
    DataSource = dtsPsqUni
    FixedColor = 16635790
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    ...
    OnDrawColumnCell = grdPsqUniDrawColumnCell
    Columns = <
      item
        Expanded = False
        Width = 10
  ...
  object stpIAEUni: TADOStoredProc
    Connection = frmMain.ADOConnection1
    ProcedureName = 'spIAEUnidProduto;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
      ...
      item
        Name = '@fl_VlInteiro_UnP'
        Attributes = [paNullable]
        DataType = ftBoolean
        Value = Null
      end
      item
        Name = '@fl_VlDecimal_UnP'
        Attributes = [paNullable]
        DataType = ftBoolean
        Value = Null
      end
  ...
  object stpPsqUni: TADOStoredProc
    Connection = frmMain.ADOConnection1
    CursorType = ctStatic
    AfterScroll = stpPsqUniAfterScroll
  ...
  object pop1: TPopupMenu
    ...
    object PopIncPes: TMenuItem
      ...
      Caption = '&Incluir novo cadastro de departamento'
    end
    object PopAltPes: TMenuItem
      ...
      Caption = '&Alterar cadastro de departamento selecionado'
    end
    object PopExcPes: TMenuItem
      Bitmap.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      Caption = '&Excluir cadastro de departamento selecionado'
    end
  end
end
