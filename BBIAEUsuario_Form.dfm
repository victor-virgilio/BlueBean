object frmIAEUsuario: TfrmIAEUsuario
  Left = 247
  Top = 117
  ...
  object edtLoginUsu: TEdit
    ...
    Width = 183
    Height = 21
    Hint = 'Digite aqui um nome para  o departamento'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    Font.Name = 'Verdana'
  ...
  object btnInc: TBitBtn
    ...
    Width = 31
    Height = 31
    Hint = 'Incluir novo cadastro de departamento'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 1
    OnClick = btnIncClick
  ...
  object btnAlt: TBitBtn
    ...
    Width = 31
    Height = 31
    Hint = 'Alterar cadastro de departamento'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 2
    OnClick = btnAltClick
  ...
  object btnExc: TBitBtn
    ...
    Width = 31
    Height = 31
    Hint = 'Excluir cadastro de departamento'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 3
    OnClick = btnExcClick
  ...
  object grdPsqUsuario: TDBGrid
    Left = 25
    Top = 43
    Width = 367
    Height = 269
    DataSource = dtsPsqUsuario
    FixedColor = 16635790
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
    ...
    TitleFont.Style = []
    OnDrawColumnCell = grdPsqUsuarioDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'C'#243'd'
  ...
  object grdPermissao: TDBGrid
    ...
    TitleFont.Name = 'Verdana'
    TitleFont.Style = []
    OnCellClick = grdPermissaoCellClick
  ...
  object stpIAEUsuario: TADOStoredProc
    Connection = frmMain.ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'spIAEUsuario;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 520
    Top = 284
    object stpIAEUsuarioid_Codigo_Usu: TIntegerField
      FieldName = 'id_Codigo_Usu'
    end
    object stpIAEUsuariods_Login_Usu: TStringField
      FieldName = 'ds_Login_Usu'
      Size = 10
    end
  end
  object dtsPsqUsuario: TDataSource
    DataSet = stpPsqUsuario
    Left = 168
    Top = 136
  end
  object stpPsqUsuario: TADOStoredProc
    Connection = frmMain.ADOConnection1
    CursorType = ctStatic
    AfterScroll = stpPsqUsuarioAfterScroll
    ProcedureName = 'spPsqUsuario;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 200
    Top = 136
    object stpPsqUsuarioCd: TIntegerField
      FieldName = 'C'#243'd'
    end
    object stpPsqUsuarioUsurio: TStringField
      FieldName = 'Usu'#225'rio'
      Size = 10
    end
    object stpPsqUsuarioMaster: TBooleanField
      FieldName = 'Master'
    end
    object stpPsqUsuariods_Senha_Usu: TStringField
      FieldName = 'ds_Senha_Usu'
      Size = 50
    end
    object stpPsqUsuariods_Lembrete_Usu: TStringField
      FieldName = 'ds_Lembrete_Usu'
      Size = 50
    end
    object stpPsqUsuarioPessoa: TStringField
      FieldName = 'Pessoa'
      ReadOnly = True
      Size = 159
    end
  ...
  object pop1: TPopupMenu
    ...
    object PopIncPes: TMenuItem
      ...
      Caption = '&Incluir novo cadastro de usu'#225'rio'
    end
    object PopAltPes: TMenuItem
      ...
      Caption = '&Alterar cadastro de usu'#225'rio selecionado'
    end
    object PopExcPes: TMenuItem
      Bitmap.Data = {
        ...
        FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
      Caption = '&Excluir cadastro de usu'#225'rio selecionado'
    end
  end
  object cdsPermissao: TClientDataSet
    ...
    Left = 776
    Top = 88
    object cdsPermissaoDescricao: TStringField
      FieldName = 'Descricao'
      Size = 50
    end
    object cdsPermissaoPermite: TBooleanField
      FieldName = 'Permite'
    end
  end
  ...
  object stpPermissao: TADOStoredProc
    Connection = frmMain.ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'spUsuPermissao'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
      ...
      item
        Name = '@fl_IncProduto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltProduto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcProduto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncDepto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltDepto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcDepto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
      ...
      item
        Name = '@fl_IncPessoa_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltPessoa_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcPessoa_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncEndereco_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltEndereco_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcEndereco_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncContato_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltContato_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcContato_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncEstqoue_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltEstoque_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcEstoque_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncUsuario_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltUsuario_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcUsuario_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_IncFormaPagto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_AltFormaPagto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_ExcFormaPagto_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_Relatorio_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
      ...
      item
        Name = '@fl_VisuValor_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@fl_RotinaCaixa_UPr'
        Attributes = [paNullable]
        DataType = ftBoolean
      end
      item
        Name = '@id_Alteracao_Usu'
        Attributes = [paNullable]
        DataType = ftInteger
        Precision = 10
      end>
